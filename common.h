...
struct std::hash<Position>
{
    ...
    {
        return 43 * position.row + position.col;
    }
};
...
using GetCellPtr = std::function<CellInterface*(Position)>;
...
public:
    ...
    // Функция очищает таблицу, приаодя её в исходное состояние.
    ...
    virtual void InsertEmptyCell(Position pos) = 0;
